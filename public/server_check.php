...
<head>
    ...
    <title>Syntiaro Server Requirement Checker</title>
...
<body>
    <div class="container-fluid pl-0 pr-0">
        <div class="content mt-5 pl-3 pr-3">
            ...
            <div class="d-flex justify-content-center mb-4">
                <span class="">This script will check if your server meets the requirements for running Syntiaro POS application</span>
            </div>
                ...
                <?php if ($env_error == true) { ?>
                    <div class="mb-1">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-center">
                                <p class="">
                                <p>Please check <span class='text-info'>.env</span> file exists in the root directory</p>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-center mb-5 pb-2">
                Powered by&nbsp;<a href="https://www.syntiaro.com">syntiaro.com</a>
            </div>
