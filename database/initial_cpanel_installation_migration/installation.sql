...
VALUES
    (
        1,
        '50qTKGfI3QOdXLn8JSMR30Ug4',
        'DEFAULT',
        'Walkin Customer',
        'walkincustomer@syntiaro.com',
        '0000000000',
        NULL,
        NULL,
        1,
...
VALUES
    ...
    (
        ...
        'arrowleft',
        'Arrow Left',
        'Move left through POS products',
        0,
        1,
        1,
        NULL,
    ...
    (
        ...
        'arrowright',
        'Arrow Right',
        'Move right through POS products',
        0,
        1,
        1,
        NULL,
    ...
    (
        9,
        'SCROLL_PAYMENT_METHODS',
        'shift,p',
        'Shift+p',
        'Scroll through payment methods',
        0,
        1,
        1,
        NULL,
    ...
    (
        11,
        'SCROLL_BUSINESS_ACCOUNTS',
        'shift,o',
        'Shift+o',
        'Scroll through business accounts',
        0,
        1,
        1,
        NULL,
    ...
    (
        15,
        'SCROLL_RESTAURANT_TABLES',
        'shift,u',
        'Shift+u',
        'Scroll through restaurant tables',
        0,
        1,
        1,
        NULL,
...
VALUES
    ...
    (
        57,
        'MASTER_TRANSACTION_TYPE_STATUS',
        '1',
        'ACTIVE',
        'Active',
        'label green-label',
...
VALUES
    ...
    (
        50,
        'ACTIONS',
        'A_DETAIL_DISCOUNTCODE',
        'View Discount Code Detail',
        '',
        16,
        3,
        NULL,
    ...
    (
        59,
        'ACTIONS',
        'A_DETAIL_PAYMENT_METHOD',
        'View Payment Method Detail',
        '',
        20,
        3,
        NULL,
    ...
    (
        115,
        'ACTIONS',
        'A_DETAIL_STOCK_TRANSFER',
        'View Stock Transfer Detail',
        '',
        112,
        3,
        NULL,
    ...
    (
        117,
        'ACTIONS',
        'A_VERIFY_STOCK_TRANSFER',
        'Verify Stock Transfer Request',
        '',
        112,
        5,
        NULL,
    ...
    (
        119,
        'ACTIONS',
        'A_VIEW_INVOICE_LISTING',
        'View Invoice Listing',
        '',
        76,
        7,
        NULL,
    ...
    (
        120,
        'ACTIONS',
        'A_VIEW_PURCHASE_ORDER_LISTING',
        'View Purchase Order Listing',
        '',
        10,
        6,
        NULL,
    ...
    (
        121,
        'ACTIONS',
        'A_VIEW_QUOTATION_LISTING',
        'View Quotation Listing',
        '',
        83,
        6,
        NULL,
    ...
    (
        129,
        'ACTIONS',
        'A_VIEW_TAXCODE_LISTING',
        'View Tax Code Listing',
        '',
        15,
        4,
        NULL,
    ...
    (
        130,
        'ACTIONS',
        'A_VIEW_DISCOUNTCODE_LISTING',
        'View Discount Code Listing',
        '',
        16,
        4,
        NULL,
    ...
    (
        133,
        'ACTIONS',
        'A_VIEW_STOCK_TRANSFER_LISTING',
        'View Stock Transfer Listing',
        '',
        112,
        6,
        NULL,
    ...
    (
        134,
        'ACTIONS',
        'A_VIEW_KITCHEN_ORDER_LISTING',
        'View Kitchen Order Listing',
        '',
        101,
        1,
        NULL,
    ...
    (
        135,
        'ACTIONS',
        'A_VIEW_RESTAURANT_TABLE_LISTING',
        'View Table Listing',
        '',
        102,
        4,
    ...
    (
        137,
        'ACTIONS',
        'A_VIEW_PAYMENT_METHOD_LISTING',
        'View Payment Method Listing',
        '',
        20,
        4,
        NULL,
    ...
    (
        141,
        'ACTIONS',
        'A_DETAIL_STOCK_RETURN',
        'View Stock Return Detail',
        '',
        138,
        3,
        NULL,
    ...
    (
        143,
        'ACTIONS',
        'A_VIEW_STOCK_RETURN_LISTING',
        'View Stock Return Listing',
        '',
        138,
        5,
        NULL,
    ...
    (
        149,
        'ACTIONS',
        'A_VIEW_NOTIFICATION_LISTING',
        'View Notification Listing',
        '',
        145,
        4,
        NULL,
    ...
    (
        151,
        'ACTIONS',
        'A_VIEW_BUSINESS_REGISTER_LISTING',
        'View Business Register Listing',
        '',
        150,
        1,
        NULL,
    ...
    (
        152,
        'ACTIONS',
        'A_DETAIL_BUSINESS_REGISTER',
        'View Business Register Detail',
        '',
        150,
        2,
        NULL,
    ...
    (
        153,
        'ACTIONS',
        'A_DELETE_BUSINESS_REGISTER',
        'Delete Business Register',
        '',
        150,
        3,
        NULL,
    ...
    (
        164,
        'ACTIONS',
        'A_VIEW_SMS_TEMPLATE_LISTING',
        'View SMS Template Listing',
        '',
        163,
        1,
        NULL,
    ...
    (
        ...
        'ACTIONS',
        'A_SHARE_INVOICE_SMS',
        'Send Invoice SMS from Order Detail Page',
        '',
        9,
        6,
        NULL,
    ...
    (
        170,
        'ACTIONS',
        'A_EDIT_BILLING_COUNTER',
        'Edit Billing Counter',
        '',
        168,
        2,
        NULL,
    ...
    (
        171,
        'ACTIONS',
        'A_DETAIL_BILLING_COUNTER',
        'View Billing Counter Detail',
        '',
        168,
        3,
        NULL,
    ...
    (
        172,
        'ACTIONS',
        'A_VIEW_BILLING_COUNTER_LISTING',
        'View Billing Counter Listing',
        '',
        168,
        4,
        NULL,
    ...
    (
        183,
        'ACTIONS',
        'A_VIEW_MEASUREMENT_UNIT_LISTING',
        'View Measurement Unit Listing',
        '',
        179,
        4,
        NULL,
    ...
    (
        185,
        'ACTIONS',
        'A_DETAIL_SMS_SETTING',
        'View SMS Setting Detail',
        '',
        161,
        3,
        NULL,
    ...
    (
        186,
        'ACTIONS',
        'A_VIEW_SMS_SETTING_LISTING',
        'View SMS Setting Listing',
        '',
        161,
        1,
        NULL,
    ...
    (
        188,
        'ACTIONS',
        'A_VIEW_DIGITAL_MENU_ORDER_LISTING',
        'View Digital Menu Order Listing',
        '',
        187,
        1,
        NULL,
    ...
    (
        189,
        'ACTIONS',
        'EDIT_DIGITAL_MENU_ORDER',
        'Edit Digital Menu Order',
        '',
        187,
        2,
        NULL,
    ...
    (
        196,
        'ACTIONS',
        'A_VIEW_BOOKING_LISTING',
        'View Booking & Event Listing',
        '',
        191,
        5,
        NULL,
    ...
    (
        198,
        'ACTIONS',
        'A_UPLOAD_ADDON_PRODUCT',
        'Upload Add-on Product',
        '',
        21,
        7,
        NULL,
    ...
    (
        203,
        'ACTIONS',
        'A_DETAIL_ADDON_GROUP',
        'View Add-on Group Detail',
        '',
        200,
        3,
        NULL,
    ...
    (
        204,
        'ACTIONS',
        'A_VIEW_ADDON_GROUP_LISTING',
        'View Add-on Group Listing',
        '',
        200,
        4,
        NULL,
    ...
    (
        210,
        'ACTIONS',
        'A_DETAIL_VARIANT_OPTION',
        'View Variant Option Detail',
        '',
        207,
        3,
        NULL,
    ...
    (
        211,
        'ACTIONS',
        'A_VIEW_VARIANT_OPTION_LISTING',
        'View Variant Option Listing',
        '',
        207,
        4,
        NULL,
...
VALUES
    ...
    (
        3,
        '2019_06_26_060037_create_user_menus_table',
        1
    ),
    (4, '2019_07_04_063904_create_roles_table', 1),
    (
        5,
        '2019_07_05_093727_create_master_status_table',
        1
    ),
    (
        6,
        '2019_08_01_095649_create_role_menus_table',
        1
    ),
    ...
    (
        9,
        '2019_08_08_064039_create_tax_codes_table_',
        1
    ),
    (
        10,
        '2019_08_08_065740_create_suppliers_table_',
        1
    ),
    (
        11,
        '2019_08_12_111921_create_tax_code_type_table',
        1
    ),
    (12, '2019_09_02_091654_create_orders_table', 1),
    (
        13,
        '2019_09_02_093147_create_order_products_table',
        1
    ),
    (
        14,
        '2019_09_02_102236_create_customers_table',
        1
    ),
    (15, '2019_09_22_143359_create_stores_table', 1),
    (
        16,
        '2019_09_25_073244_create_user_stores_table',
        1
    ),
    (
        17,
        '2019_10_07_110215_create_discount_codes_table',
        1
    ),
    (
        18,
        '2019_10_19_120057_create_payment_methods_table',
        1
    ),
    (
        19,
        '2019_11_12_185655_create_purchase_orders_table',
        1
    ),
    (
        20,
        '2019_11_13_094741_create_purchase_order_products_table',
        1
    ),
    (21, '2019_11_13_111337_create_country_table', 1),
    (
        22,
        '2019_12_11_113654_create_setting_mail_table',
        1
    ),
    (
        23,
        '2019_12_28_083017_create_setting_app_table',
        1
    ),
    (
        24,
        '2019_12_30_071527_create_master_date_format_table',
        1
    ),
    (
        25,
        '2020_01_08_182121_create_master_invoice_print_type_table',
        1
    ),
    (26, '2020_01_28_171546_create_sessions_table', 1),
    (
        27,
        '2020_01_30_065150_create_user_access_tokens_table',
        1
    ),
    (28, '2020_02_27_064522_create_invoices_table', 1),
    (
        29,
        '2020_02_27_072412_create_invoice_products_table',
        1
    ),
    (
        30,
        '2020_02_27_074121_create_quotations_table',
        1
    ),
    (
        31,
        '2020_02_27_074135_create_quotation_products_table',
        1
    ),
    (32, '2020_02_29_074629_v2_overall', 1),
    (
        33,
        '2020_03_03_050937_create_transactions_table',
        1
    ),
    (
        34,
        '2020_03_03_102455_create_master_transaction_type_table',
        1
    ),
    (
        35,
        '2020_03_03_102515_create_master_account_type_table',
        1
    ),
    (36, '2020_03_03_102548_create_accounts_table', 1),
    (
        37,
        '2020_03_09_141052_create_master_tax_option_table',
        1
    ),
    (38, '2020_03_13_152912_v3_overall', 1),
    (
        39,
        '2020_03_13_153828_create_master_order_type_table',
        1
    ),
    (
        40,
        '2020_03_15_065302_create_restaurant_tables_table',
        1
    ),
    (
        41,
        '2020_03_20_094226_create_languages_table',
        1
    ),
    (42, '2020_03_28_102831_create_targets_table', 1),
    (
        43,
        '2020_03_29_071430_create_stock_transfer_table',
        1
    ),
    (
        44,
        '2020_03_29_071439_create_stock_transfer_products_table',
        1
    ),
    ...
    (
        47,
        '2020_04_11_071059_create_stock_returns_table',
        1
    ),
    (
        48,
        '2020_04_11_071114_create_stock_return_products_table',
        1
    ),
    (
        49,
        '2020_04_12_171035_create_notifications_table',
        1
    ),
    (
        50,
        '2020_04_25_081734_create_business_register_table',
        1
    ),
    ...
    (
        53,
        '2020_05_16_062207_create_master_billing_type_table',
        1
    ),
    (
        54,
        '2020_05_23_085819_create_setting_sms_gateways_table',
        1
    ),
    (
        55,
        '2020_05_25_121920_create_sms_templates_table',
        1
    ),
    (
        56,
        '2020_05_31_081201_create_billing_counters_table',
        1
    ),
    ...
    (
        59,
        '2020_07_02_152556_create_keyboard_shortcuts_table',
        1
    ),
    (60, '2020_07_16_125331_create_v4_6_overall', 1),
    (
        61,
        '2020_08_01_060605_create_product_images_table',
        1
    ),
    (62, '2020_08_10_100344_create_v4_7_overall', 1),
    (
        63,
        '2020_08_31_080009_create_product_ingredients_table',
        1
    ),
    (
        64,
        '2020_08_31_080108_create_measurement_units_table',
        1
    ),
    ...
    (
        69,
        '2020_12_23_165619_create_app_activation_table',
        1
    ),
    (70, '2021_01_14_184837_create_v5_0_overall', 1),
    (
        71,
        '2021_01_20_203541_create_addon_groups_table',
        1
    ),
    (
        72,
        '2021_01_21_145500_create_addon_group_products_table',
        1
    ),
    (
        73,
        '2021_01_25_113548_create_product_addon_groups_table',
        1
    ),
    ...
    (
        77,
        '2021_09_25_193934_create_product_variants_table',
        1
    ),
    (
        78,
        '2021_09_26_074804_create_variant_options_table',
        1
    );
...
VALUES
    (
        1,
        '2R8rJj6sFQAZqDaTIzx6GWNi3',
        'POS_SALE_BILL_MESSAGE',
        'Thank you for shopping. Order {order_number}. Order amount {currency_code} {order_amount}. Link to view your ebill {public_order_link}',
        '{order_number}, {order_amount}, {currency_code}, {payment_method}, {customer_name}, {customer_email}, {customer_phone}, {order_date}, {public_order_link}',
        'This SMS will be sent to the customer while you close an order. Given the customer has a valid phone number updated.',
        0,
        1,
        NULL,
        '2021-11-26 08:57:30',
...
INSERT INTO
    `users` (
        ...
        `password_reset_max_tries`,
        `password_reset_last_tried_on`,
        `phone`,
        `profile_image`,
        `role_id`,
        `store_id`,
...
VALUES
    (
        1,
        'XJ0699ZSWajyxvYRNt6CBZyGa',
        'SA',
        'Syntiaro Admin',
        'admin@syntiaro.com',
        '$2y$10$YCeRIaNFfikriDJ/ALyMneUt3TPlf1u9TW3mwVvQZz5jEnveZrUwK',
        NULL,
        NULL,
        0,
        NULL,
    ...
    (
        2,
        'j2BbhCeGif8LxAKPPNmijtdfD',
        'CUSTOMER_USER',
        'Customer',
        'customer@syntiaro.com',
        '',
        NULL,
        NULL,
        0,
...
ADD
    KEY `accounts_store_id_account_type_status_index` (`store_id`, `account_type`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `addon_groups_slack_unique` (`slack`),
ADD
    KEY `addon_group_indexes` (`store_id`, `addon_group_code`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `addon_group_products_product_id_addon_group_id_index` (`product_id`, `addon_group_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `billing_counters_slack_unique` (`slack`),
ADD
    KEY `billing_counters_store_id_billing_counter_code_status_index` (`store_id`, `billing_counter_code`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `bookings_slack_unique` (`slack`),
ADD
    UNIQUE KEY `bookings_event_code_unique` (`event_code`),
ADD
    KEY `bookings_store_id_start_date_end_date_email_phone_index` (
        `store_id`,
        `start_date`,
        `end_date`,
        `email`,
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `business_registers_slack_unique` (`slack`),
ADD
    KEY `business_register_indexes` (`user_id`, `store_id`),
ADD
    KEY `business_registers_billing_counter_id_index` (`billing_counter_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `category_slack_unique` (`slack`),
ADD
    KEY `category_status_store_id_category_code_index` (`status`, `store_id`, `category_code`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `country_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `customers_slack_unique` (`slack`),
ADD
    KEY `customers_email_phone_status_index` (`email`, `phone`, `status`);
...
ADD
    KEY `invoice_products_invoice_id_status_index` (`invoice_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `keyboard_shortcuts_keyboard_constant_unique` (`keyboard_constant`),
ADD
    KEY `keyboard_shortcuts_status_keyboard_constant_index` (`status`, `keyboard_constant`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `languages_language_constant_unique` (`language_constant`),
ADD
    UNIQUE KEY `languages_language_code_unique` (`language_code`),
ADD
    KEY `language_tables_indexes` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `master_account_type_account_type_constant_unique` (`account_type_constant`),
ADD
    KEY `master_account_type_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `master_billing_type_billing_type_constant_unique` (`billing_type_constant`),
ADD
    KEY `master_billing_type_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `master_order_type_order_type_constant_unique` (`order_type_constant`),
ADD
    KEY `master_order_type_order_type_constant_status_index` (`order_type_constant`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `master_status_key_value_value_constant_status_index` (`key`, `value`, `value_constant`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `master_tax_option_tax_option_constant_unique` (`tax_option_constant`),
ADD
    KEY `master_tax_option_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `master_transaction_type_transaction_type_constant_unique` (`transaction_type_constant`),
ADD
    KEY `master_transaction_type_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `measurement_units_slack_unique` (`slack`),
ADD
    KEY `measurement_units_unit_code_status_index` (`unit_code`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `menus_menu_key_unique` (`menu_key`),
ADD
    KEY `menus_type_menu_key_parent_status_index` (`type`, `menu_key`, `parent`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `notifications_slack_unique` (`slack`),
ADD
    KEY `notification_indexes` (`user_id`, `status`);
...
ADD
    KEY `orders_customer_id_store_id_status_index` (`customer_id`, `store_id`, `status`),
ADD
    KEY `orders_kitchen_status_index` (`kitchen_status`),
ADD
    KEY `orders_register_id_index` (`register_id`),
ADD
    KEY `orders_payment_method_id_index` (`payment_method_id`),
ADD
    KEY `orders_order_origin_index` (`order_origin`),
ADD
    KEY `orders_payment_status_order_merged_order_merge_parent_id_index` (
        `payment_status`,
        `order_merged`,
        `order_merge_parent_id`
    );
...
ADD
    KEY `order_products_merged_from_merged_to_index` (`merged_from`, `merged_to`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `otp_event_type_user_id_customer_id_otp_index` (`event_type`, `user_id`, `customer_id`, `otp`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `payment_methods_slack_unique` (`slack`),
ADD
    KEY `payment_methods_status_index` (`status`),
ADD
    KEY `payment_methods_activate_on_digital_menu_index` (`activate_on_digital_menu`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `products_slack_unique` (`slack`),
ADD
    KEY `products_status_store_id_product_code_index` (`status`, `store_id`, `product_code`),
ADD
    KEY `products_is_addon_product_is_ingredient_index` (`is_addon_product`, `is_ingredient`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `product_addon_groups_product_id_addon_group_id_index` (`product_id`, `addon_group_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `product_images_slack_unique` (`slack`),
ADD
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `product_ingredients_slack_unique` (`slack`),
ADD
    KEY `product_ingredients_index` (
        `product_id`,
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `purchase_orders_slack_unique` (`slack`),
ADD
    UNIQUE KEY `purchase_orders_po_number_unique` (`po_number`),
ADD
    KEY `purchase_orders_store_id_po_number_supplier_id_status_index` (`store_id`, `po_number`, `supplier_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `purchase_order_products_slack_unique` (`slack`),
ADD
    KEY `purchase_order_products_purchase_order_id_status_index` (`purchase_order_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `quotation_products_slack_unique` (`slack`),
ADD
    KEY `quotation_products_quotation_id_status_index` (`quotation_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `restaurant_tables_slack_unique` (`slack`),
ADD
    KEY `restaurant_tables_indexes` (`store_id`, `status`),
ADD
    KEY `restaurant_tables_waiter_user_id_index` (`waiter_user_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `roles_slack_unique` (`slack`),
ADD
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `role_menus_role_id_menu_id_index` (`role_id`, `menu_id`);
...
ALTER TABLE
    `setting_app`
ADD
    KEY `setting_app_company_name_app_date_format_index` (`company_name`, `app_date_format`),
ADD
    KEY `setting_app_app_title_index` (`app_title`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `setting_mail_slack_unique` (`slack`),
ADD
    KEY `setting_mail_type_status_index` (`type`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `setting_sms_gateways_slack_unique` (`slack`),
ADD
    KEY `setting_sms_gateways_account_id_token_twilio_number_index` (`account_id`, `token`, `twilio_number`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `sms_templates_slack_unique` (`slack`),
ADD
    UNIQUE KEY `sms_templates_template_key_unique` (`template_key`),
ADD
    KEY `sms_templates_status_index` (`status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `stock_returns_slack_unique` (`slack`),
ADD
    UNIQUE KEY `stock_returns_return_number_unique` (`return_number`),
ADD
    KEY `return_indexes` (`store_id`, `bill_to`, `bill_to_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `stock_return_products_slack_unique` (`slack`),
ADD
    KEY `stock_return_products_stock_return_id_status_index` (`stock_return_id`, `status`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `stock_transfer_slack_unique` (`slack`),
ADD
    UNIQUE KEY `stock_transfer_stock_transfer_reference_unique` (`stock_transfer_reference`),
ADD
    KEY `stock_transfer_store_id_from_store_id_to_store_id_status_index` (
        `store_id`,
        `from_store_id`,
        `to_store_id`,
        `status`
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `stock_transfer_products_slack_unique` (`slack`),
ADD
    KEY `stock_transfer_product_indexes` (
        `stock_transfer_id`,
        `product_id`,
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `stores_slack_unique` (`slack`),
ADD
    UNIQUE KEY `stores_store_code_unique` (`store_code`),
ADD
    KEY `stores_status_index` (`status`),
ADD
    KEY `stores_restaurant_mode_index` (`restaurant_mode`),
ADD
    KEY `menu_otp_language_index` (
        `enable_digital_menu_otp_verification`,
        `menu_language_id`
    ),
ADD
    KEY `stores_digital_menu_send_order_to_kitchen_index` (`digital_menu_send_order_to_kitchen`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `suppliers_slack_unique` (`slack`),
ADD
    KEY `suppliers_status_store_id_supplier_code_index` (`status`, `store_id`, `supplier_code`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `targets_slack_unique` (`slack`),
ADD
    KEY `targets_store_id_month_index` (`store_id`, `month`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `tax_codes_slack_unique` (`slack`),
ADD
    KEY `tax_codes_status_store_id_tax_code_index` (`status`, `store_id`, `tax_code`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `tax_code_type_tax_code_id_index` (`tax_code_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `transactions_slack_unique` (`slack`),
ADD
    UNIQUE KEY `transactions_transaction_code_unique` (`transaction_code`),
ADD
    KEY `transaction_indexes` (
        `store_id`,
        `account_id`,
        `transaction_type`,
        `bill_to`,
...
ADD
    KEY `transactions_merged_from_merged_to_index` (`merged_from`, `merged_to`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `users_slack_unique` (`slack`),
ADD
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `user_menus_user_id_menu_id_index` (`user_id`, `menu_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    KEY `user_stores_user_id_store_id_index` (`user_id`, `store_id`);
...
ADD
    PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `variant_options_slack_unique` (`slack`),
ADD
    KEY `variant_option_indexes` (`store_id`, `variant_option_code`, `status`);
