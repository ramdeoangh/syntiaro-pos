                            ...
                            <div class="mr-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-3 align-self-center customer">
                                        ...
                                        <div class="d-block"> 
                                            <span class="d-block text-left" v-if="order_basic.customer_email != 'walkincustomer@syntiaro.com'">Email : {{ (order_basic.customer_email == null)?'-':order_basic.customer_email }} </span>
