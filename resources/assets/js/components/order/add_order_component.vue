        ...
        <div class="col-md-8 p-0 bg-white border-right">
            ...
            <div class="p-0 border-bottom">
                <div class="d-flex flex-nowrap justify-content-between p-3 horizontal-scroll hide-horizontal-scroll">
                    ...
                    <button class="btn btn-primary btn-light ml-3" v-on:click="get_keyboard_shortcuts()" v-if="keyboard_shortcuts.length > 0"><i class="fas fa-keyboard"></i></button>
                    ...
                    <button class="btn btn-primary btn-light ml-3" v-on:click="get_digital_menu_orders_list(1)" v-if="store_restaurant_mode == true"> {{ $t("Digital Menu Orders") }}</button>

                    <button class="btn btn-primary btn-light ml-3" v-on:click="get_running_orders_list(1)" v-if="store_restaurant_mode == true"> {{ $t("Running Orders") }}</button>

                    <button class="btn btn-primary btn-light ml-3" v-on:click="get_hold_list"> {{ $t("Hold List") }}</button>

                    <button class="btn btn-danger ml-3" v-on:click="close_register"> <i class="fas fa-cash-register"></i>&ensp;{{ $t("Close Register") }}</button>
                </div>
            </div>
                ...
                <form data-vv-scope="confirmation_form">
                    ...
                    <div v-if="order_restaurant_mode == 1">
                        <div class="form-group">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="row flex-fill">
                                    <div class="col-md-4" v-for="(restaurant_order_type_item, index) in restaurant_order_types" v-bind:value="restaurant_order_type.order_type_constant" v-bind:key="index">
