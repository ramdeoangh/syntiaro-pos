        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2" v-for="(tax_type_item, index) in tax_types" :key="index">
                    <div class="form-group col-md-3">
                        <input type="text" v-bind:name="'tax_type_item.tax_type_'+index" data-vv-as="Tax Type" v-model="tax_type_item.tax_type" v-validate="'required'" class="form-control form-control-custom" :placeholder="$t('Please enter tax type')"  autocomplete="off">
                        <span v-bind:class="{ 'error' : errors.has('tax_type_item.tax_type_'+index) }">{{ errors.first('tax_type_item.tax_type_'+index) }}</span> 
                    </div>
                    <div class="form-group col-md-3">
                        <input type="number" v-bind:name="'tax_type_item.tax_percentage_'+index" data-vv-as="Tax Percentage" v-model="tax_type_item.tax_percentage" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="$t('Please enter tax percentage')"  autocomplete="off" step="0.01" min="0">
