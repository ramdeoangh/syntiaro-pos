            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-6">
                        <div class="custom-control custom-switch ml-1">
                            ...
                            <small class="form-text text-muted">If this option is enabled, product will be considered as an add-on product. Add-on products can only be tagged to a billing product via add-on groups</small>
                        </div>
                    </div>
                    <div class="form-group col-md-6 border-left" v-if="restaurant_mode == 1">
                        <div class="custom-control custom-switch ml-1">
                            ...
                            <small class="form-text text-muted">If this option is enabled, product will be added as an ingredient.</small>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='sale_price' v-model="sale_price" v-validate="'required|decimal'" class="form-control form-control-custom" :placeholder="$t('Please enter sale price excluding tax')"  autocomplete="off" step="0.01" min="0">
                ...
                <div v-if="restaurant_mode == 1 && is_ingredient == 0 && is_addon_product == 0">
                    ...
                    <div>
                        ...
                        <div class="form-row mb-2">
                            ...
                            <div class="form-group col-md-3">
                                <label for="description">{{ $t("Total Ingredient Selling Price") }}</label>
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_ingredient_price" v-model="is_ingredient_price" @change='update_product_prices()'>
                                    <label class="custom-control-label" for="is_ingredient_price">{{ $t("Set Product Price as Ingredient Cost") }}</label>
                                    <small class="form-text text-muted">If this option is enabled, product sale price and purchase price will be replaced with ingredient cost.</small>
                                </div>
                            </div>
                        </div>
                    </div>
