    ...
    <body >
        ...
        <div class='border-bottom-dashed pt-1rem mb-1rem'>
            <table class='w-100'>
                ...
                @endif
                <tr>
                    <td class='w-50'>Customer: {{ $data->customer_name}}</td>
                    <td class='right'>Payment Method: {{ $data->payment_method }}</td>
                </tr>
            </table>
        </div>

        <table class='border-bottom-dashed mb-1rem w-100 table-extended page-break-avoid'>
            <tr>
                <td class='bold w-38'>Description</td>
                <td class='bold right'>Qty</td>
                <td class='bold right'>Rate</td>
                <td class='bold right'>Tax/Dis</td>
            ...
            <tr>
                ...
                <td class='{{ $spacing }} right'>{{ $order_products->tax_amount }}<br>{{ $order_products->discount_amount }}</td>
